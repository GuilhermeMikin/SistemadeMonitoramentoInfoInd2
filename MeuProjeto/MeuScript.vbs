...
Sub Inserir()
    ...
    ' '3) USANDO-SE OLEDB DataShape
    ' Connection.Open "Provider=ADsDSOObject;Password="";User ID=Admin;Encrypt Password=False;Data Source=D:\Engenharia de Controle e Automação\IFIND 2\TRABALHO_T1\MeuProjeto\minhadatabase.mdb;Mode=ReadWrite;Bind Flags=0;ADSI Flag=-2147483648"
